...
FIGURES = [
    {'label':'fig:sanlorenzo','filename':'usgs.png','category':'Setup / Inputs','role':'Study-setting figure','bundle':'generated/setup_support_by_cutoff_v2/20221225_exal_m_t1/figures/usgs.png','note':'Representative 2022-12-25 setup/support v2 figure'},
    {'label':'fig:covariates','filename':'precip_soilmoisture_climatePC1_faceted_labeled.png','category':'Setup / Inputs','role':'Covariate setup figure','bundle':'generated/setup_support_by_cutoff_v2/20221225_exal_m_t1/figures/precip_soilmoisture_climatePC1_faceted_labeled.png','note':'Representative 2022-12-25 setup/support v2 figure'},
    {'label':'fig:retrospectives','filename':'retrospective_log_discharge_plot_faceted.png','category':'Setup / Inputs','role':'Retrospective-product setup figure','bundle':'generated/setup_support_by_cutoff_v2/20221225_exal_m_t1/figures/retrospective_log_discharge_plot_faceted.png','note':'Representative 2022-12-25 setup/support v2 figure'},
    {'label':'fig:ensembles','filename':'forecats.png','category':'Setup / Inputs','role':'Forecast-product setup figure','bundle':'generated/setup_support_by_cutoff_v2/20221225_exal_m_t1/figures/forecats.png','note':'Representative 2022-12-25 setup/support v2 figure'},
