...
\caption{
Observed USGS daily water flow (log-log scale, cm$^3$/s) over the full historical daily record used for the representative December 25, 2022 cutoff-specific input bundle, spanning May 29, 1987 through December 25, 2022. Horizontal dashed lines indicate NOAA-defined minor (16.5 ft, 503 cm) and major (21.76 ft, 663 cm) flooding thresholds, converted to the plotting scale.
}
...
We summarize these climate indices with the first generalized dynamic principal component (GDPC) \citep{JSSv092c02}. This factor serves as a single large-scale climate summary that captures their dominant common variation through time. The number of leads and lags is selected by leave-one-out cross-validation, and the first component explains 53.42\% of the total variability among the indices.

The transfer covariates used in the application are therefore standardized precipitation, standardized soil moisture, and the first GDPC factor. Figure~\ref{fig:covariates} shows these three explanatory series over the full historical daily window available to the representative December 25, 2022 cutoff-specific input bundle.

\begin{figure*}[hbt!]
\centering
\centerline{\includegraphics[width=450pt]{DISC/precip_soilmoisture_climatePC1_faceted_labeled.png}}
\caption{
Historical precipitation, soil moisture, and first GDPC covariate series over the May 29, 1987 through December 25, 2022 daily window used by the representative December 25, 2022 cutoff-specific input bundle. The figure is rendered directly from the raw cutoff-specific covariate files used by that bundle.
}
...
The retrospective products enter the estimation period and are used to learn source-specific discrepancies relative to the USGS target series. Figure~\ref{fig:retrospectives} shows the corresponding retrospective series over the support window actually preserved for the representative December 25, 2022 cutoff-specific input bundle. For this cutoff, the selected short-window synthetic-retrospective bundle begins on January 10, 2020 rather than at the 1987 study start, whereas the full-history support remains available in the USGS and covariate files.
...
\caption{Selected GloFAS and NWS retrospective series over the retrospective support window preserved for the representative December 25, 2022 cutoff-specific input bundle, spanning January 10, 2020 through December 25, 2022. The NWS panel follows the synthetic-retrospective lane used in that bundle, while the GloFAS panel follows the corresponding cutoff-era historical retrospective selection.}
...
GloFAS issues forecast products daily, whereas NWS issues them hourly. To maintain temporal consistency across sources, we aggregate the NWS products to daily resolution and then retain only the most recent daily issue available at each cutoff. Figure~\ref{fig:ensembles} illustrates the resulting information structure for the representative cutoff on December 25, 2022 in a compact display that spans 28 days before and 28 days after the cutoff. The GloFAS forecast window extends from December 26, 2022 to January 22, 2023, whereas the NWS forecast window extends from December 26, 2022 to January 2, 2023.

\begin{figure*}[hbt!]
\centering
\centerline{\includegraphics[width=450pt]{DISC/forecats.png}}
\caption{
\textbf{Cutoff-centered display (2022-11-27 to 2023-01-22):} The panel shows 28 days before and 28 days after the December 25, 2022 cutoff. Before the cutoff, Green—USGS observations; Purple—NWS synthetic retrospective product; Orange—GloFAS retrospective product. After the cutoff, Red—future USGS observations used only for verification; Purple—NWS 7-member forecast product, covering 2022-12-26 to 2023-01-02; Orange—GloFAS 51-member forecast product, covering 2022-12-26 to 2023-01-22. Horizontal dashed lines indicate official flood-stage thresholds for the river.
}
\label{fig:ensembles}
\end{figure*}
...
Table~\ref{tab:benchmark_crps_models} yields a consistent ranking across the five cutoffs. The \(U\) versus \(M\) comparison isolates whether the external source channels improve forecast skill beyond using the observation channel alone, whereas the \(T0\) versus \(T1\) comparison isolates whether carrying the transfer component into the forecast window is beneficial. The two multivariate specifications with an active forecast-window transfer component, AL-M-T1 and exAL-M-T1, dominate the comparison, with exAL-M-T1 attaining the lowest CRPS in every cutoff. AL-M-T1 is the closest competitor, especially at 01/23/2021 and 05/11/2022, but it remains second in each case. The best corrected model also improves on the best raw forecast-product baseline in all five cutoffs. Forecast skill is therefore highest when retrospective products are synthesized jointly with the observations and when the transfer component remains active during the forecast window. We use exAL-M-T1 as the reference specification for the remaining summaries.
...
To illustrate how the selected specification behaves across contrasting hydrological conditions, we show historical quantile summaries over two representative periods: the 2012--2016 drought and the 2017--2019 wet period. These figures are included as historical summaries of the fitted specification, not as a second forecast-validation exercise and not as additional rolling-origin evidence.

\begin{figure}[h]
\centering
\includegraphics[width=450pt]{DISC/All_exal_2012-2016_DISC.png}
\caption{
Historical posterior mean and 95\% credible intervals of river-flow quantiles during the dry period (2012--2016), shown as a descriptive historical summary under the selected specification. Shown are estimates for the 5th (red), 50th (green), and 95th (blue) quantile models, along with observed daily USGS flow (black). Horizontal dashed lines mark NOAA-defined minor and major flooding thresholds.
}
...
\caption{
Historical posterior mean and 95\% credible intervals of river-flow quantiles during the wet period (2017--2019), shown as a descriptive historical summary under the selected specification. Shown are estimates for the 5th (red), 50th (green), and 95th (blue) quantile models, along with observed daily USGS flow (black). Horizontal dashed lines mark NOAA-defined minor and major flooding thresholds.
}
\label{fig:rainy_quantile}
\end{figure}

Figures~\ref{fig:dry_quantile} and \ref{fig:rainy_quantile} show clear differences between the drought and wet periods in these historical summaries. During 2012--2016, the posterior bands remain comparatively narrow and the upper tail rarely approaches the flood thresholds. During 2017--2019, the upper tail widens substantially during the main winter events, and the 95th quantile exceeds the major flood stage in 2017 and 2019.
...
\caption{
Representative synthesized posterior predictive distribution for river flow (log-log scale, cm$^3$/s) at the San Lorenzo River for the December 25, 2022 cutoff. Observed USGS measurements before the cutoff are shown in green; unobserved future measurements are shown in red. Retrospective products (gray) are shown before December 25, and ensemble forecasts (gray) from GloFAS and NWS are shown after this date. Horizontal dashed lines indicate NOAA-defined minor and major flooding thresholds. The thin black lines shown along with the synthesized distribution (pink) correspond to the quantiles of the synthesized distribution (percentiles: 0.05, 0.20, 0.35, 0.5, 0.65, 0.8, 0.95).
}
\label{fig:synth1}
\end{figure}
...
The reusable estimation routines for the extended dynamic quantile linear model are available through the CRAN R package \texttt{exdqlm}. The end-to-end forecasting workflow used in this study is available at \url{https://github.com/AntonioAPDL/Project1}. Applying that workflow to a new basin still requires constructing a basin-specific, version-consistent archive of observations, retrospective products, forecast products, and forecast covariates.
...
\end{tabular*}
\begin{tablenotes}
\item \textit{Note:} Entries show the posterior median and the 95\% credible interval $[{\rm Q2.5}, {\rm Q97.5}]$ for each source and quantile at the representative December 25, 2022 cutoff. USGS = U.S. Geological Survey; GloFAS = Global Flood Awareness System; NWS = National Weather Service.
\end{tablenotes}
\end{table*}
...
\caption{
Historical posterior mean and 95\% credible intervals for the 80-month seasonal component of river flow from 1991 to 2022, shown as a descriptive long-cycle summary under the selected specification. Estimates are shown for the 5th (red), 50th (green), and 95th (blue) quantiles, with observed USGS daily flow in black for reference.
}
\label{fig:80_components}
\end{figure}

Figure~\ref{fig:80_components} shows that the 80-month seasonal component is broadly aligned across the three representative quantiles and captures multi-year wet and dry phases in the historical record. Its role is descriptive: it summarizes the long-cycle behavior recovered by the fitted specification rather than providing additional forecast-window validation evidence.
...
The main text shows the representative December 25, 2022 setup and support figures individually. For completeness, this appendix collects the corresponding setup/support panels for the other rolling-origin cutoffs used in the Bayesian forecast validation. Each panel contains four views for the same cutoff: observed USGS history to the cutoff, the historical PPT/SOIL/PCA covariate histories, the retrospective support actually used by the fitted models, and the cutoff-centered forecast-product context. These supplementary panels are included for documentation and reader inspection rather than as separate forecast-validation evidence.

\begin{figure}[p]
\centering
\includegraphics[width=450pt]{generated/setup_support_by_cutoff_v2_appendix/20210123_exal_m_t1_panel.png}
\caption{
...
\begin{figure}[p]
\centering
\includegraphics[width=450pt]{generated/setup_support_by_cutoff_v2_appendix/20211112_exal_m_t1_panel.png}
\caption{
...
\begin{figure}[p]
\centering
\includegraphics[width=450pt]{generated/setup_support_by_cutoff_v2_appendix/20211221_exal_m_t1_panel.png}
\caption{
...
\begin{figure}[p]
\centering
\includegraphics[width=450pt]{generated/setup_support_by_cutoff_v2_appendix/20220511_exal_m_t1_panel.png}
\caption{
