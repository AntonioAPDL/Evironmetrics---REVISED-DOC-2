...
\caption{
Observed USGS daily water flow on the $\log(\log(1 + x))$ scale, with $x$ measured in m$^3$/s, over the full historical daily record used for the representative December 25, 2022 cutoff-specific input bundle, spanning May 29, 1987 through December 25, 2022. Horizontal dashed lines indicate NOAA-defined minor (16.5 ft, 503 cm) and major (21.76 ft, 663 cm) flooding thresholds, converted to the plotting scale.
}
...
\caption{Selected GloFAS and NWS retrospective series over the corrected full-history retrospective support window preserved for the representative December 25, 2022 cutoff-specific input bundle, spanning May 29, 1987 through December 25, 2022. The representative bundle follows the revised long-history retrospective contract used for the updated figure workflow.}
