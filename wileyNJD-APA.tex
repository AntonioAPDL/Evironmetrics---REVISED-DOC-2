...
\caption{Selected GloFAS and NWS retrospective series over the corrected full-history retrospective support window preserved for the representative December 25, 2022 cutoff-specific input bundle, spanning May 29, 1987 through December 25, 2022. The representative bundle follows the revised long-history retrospective contract used for the updated figure workflow, and the displayed flow values use the $\log(1+x)$ support scale with $x$ in m$^3$/s.}
...
\caption{
\textbf{Cutoff-centered display (2022-11-27 to 2023-01-22):} The panel shows 28 days before and 28 days after the December 25, 2022 cutoff on the $\log(1+x)$ support scale with $x$ in m$^3$/s. Before the cutoff, Green—USGS observations; Purple—NWS retrospective product over the selected-run window; Orange—GloFAS retrospective product. After the cutoff, Red—future USGS observations used only for verification; Purple—NWS 7-member forecast product, covering 2022-12-26 to 2023-01-02; Orange—GloFAS 51-member forecast product, covering 2022-12-26 to 2023-01-22. Horizontal dashed lines indicate official flood-stage thresholds for the river.
}
\label{fig:ensembles}
\end{figure*}
