...
\caption{
Observed USGS daily water flow (log-log scale, cm$^3$/s) over the historical support window used by the representative December 25, 2022 cutoff-specific input bundle, spanning January 10, 2020 through December 25, 2022. Horizontal dashed lines indicate NOAA-defined minor (16.5 ft, 503 cm) and major (21.76 ft, 663 cm) flooding thresholds, converted to the plotting scale.
}
...
The transfer covariates used in the application are therefore standardized precipitation, standardized soil moisture, and the first GDPC factor. Figure~\ref{fig:covariates} shows these three explanatory series over the representative historical support window associated with the December 25, 2022 cutoff-specific input bundle.

\begin{figure*}[hbt!]
\centering
\centerline{\includegraphics[width=450pt]{DISC/precip_soilmoisture_climatePC1_faceted_labeled.png}}
\caption{
Historical precipitation, soil moisture, and first GDPC covariate series over the January 10, 2020 through December 25, 2022 support window used by the representative December 25, 2022 cutoff-specific input bundle. The figure is rendered directly from the raw cutoff-specific covariate files used by that bundle.
}
...
The retrospective products enter the estimation period and are used to learn source-specific discrepancies relative to the USGS target series. Figure~\ref{fig:retrospectives} shows the corresponding retrospective series over the same representative historical support window used by the December 25, 2022 cutoff-specific input bundle.
...
\caption{Selected GloFAS and NWS retrospective series over the January 10, 2020 through December 25, 2022 support window used by the representative December 25, 2022 cutoff-specific input bundle. The NWS panel follows the synthetic-retrospective lane used in that bundle, while the GloFAS panel follows the corresponding cutoff-era historical retrospective selection.}
...
GloFAS issues forecast products daily, whereas NWS issues them hourly. To maintain temporal consistency across sources, we aggregate the NWS products to daily resolution and then retain only the most recent daily issue available at each cutoff. Figure~\ref{fig:ensembles} illustrates the resulting information structure for the representative cutoff on December 25, 2022, using the same cutoff-specific support window shown in Figures~\ref{fig:sanlorenzo}--\ref{fig:retrospectives}. The GloFAS forecast window extends from December 26, 2022 to January 22, 2023, whereas the NWS forecast window extends from December 26, 2022 to January 5, 2023.

\begin{figure*}[hbt!]
\centering
\centerline{\includegraphics[width=450pt]{DISC/forecats.png}}
\caption{
\textbf{Historical support window (2020-01-10 to 2022-12-25):} Green—USGS observations; Purple—NWS synthetic retrospective product; Orange—GloFAS retrospective product. \textbf{Forecast window (from 2022-12-26 onward):} Red—future USGS observations used only for verification; Purple—NWS 7-member forecast product, covering 2022-12-26 to 2023-01-05; Orange—GloFAS 51-member forecast product, covering 2022-12-26 to 2023-01-22. Horizontal dashed lines indicate official flood-stage thresholds for the river.
}
\label{fig:ensembles}
\end{figure*}
