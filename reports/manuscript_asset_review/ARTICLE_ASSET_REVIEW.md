...
| `fig:covariates` | Covariate setup figure | `figures/manuscript/covariate_context_precip_soil_pca.png` | `artifacts/five_cutoff_setup_support/20221225_exal_m_t1/figures/precip_soilmoisture_climatePC1_faceted_labeled.png` | 262 | yes | Representative 2022-12-25 setup/support figure from the canonical five-cutoff support bundle |
