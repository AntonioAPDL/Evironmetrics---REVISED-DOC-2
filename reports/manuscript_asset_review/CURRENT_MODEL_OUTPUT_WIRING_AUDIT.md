...
| `fig:covariates` | Figure 2 | `figures/manuscript/covariate_context_precip_soil_pca.png` | `artifacts/five_cutoff_setup_support/20221225_exal_m_t1/figures/precip_soilmoisture_climatePC1_faceted_labeled.png` | Yes | Representative 2022-12-25 setup/support figure from the canonical five-cutoff support bundle |
...
| `fig:synth1` | Figure 7 | `figures/manuscript/representative_synthesis_multivariate.png` | `artifacts/representative_selected_model_2022_12_25/representative_synthesis_multivariate.png` | Yes | Verified representative 2022-12-25 exAL-M-T1 output |
