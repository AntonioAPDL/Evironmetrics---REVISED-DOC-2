...
| `manuscript_asset_review` | Top-level review report, gallery, and wiring audit for manuscript figures and tables. | 6 | 0 | no | `ARTICLE_ASSET_REVIEW.md | CURRENT_MODEL_OUTPUT_WIRING_AUDIT.md | figure_gallery.html` |
